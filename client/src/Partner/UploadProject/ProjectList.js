  ...
  return (
    ...
    >
      <Box sx={style}>
        ...
        <br />
        <div>
          <label htmlFor="gender">Project Brief:</label>
          <Input
            label="NA"
            id="gender"
            name="gender"
        ...
        <br />
        {/* <div>
          <label htmlFor="f_mobile">Scheme:</label>
          <Input
            label="NA"
            id="f_mobile"
            name="f_mobile"
        ...
        <div>
          <label htmlFor="required">Referee Remark:</label>
          <Input
            label="NA"
            id="remark"
            name="remark"
            value={data?.referee_remark}
            placeholder={`NA`}
          // onChange={onChangeData}
          />
        </div>
...
const TableData = (props) => {
  ...
  const generateColumns = (user) => {
    ...
    if (user?.role && user?.permission?.includes("first-approval")) {
    ...
    } else if (user?.role && user?.permission?.includes("second-approval")) {
      roleSpecificColumns.push({
        field: "approve",
        headerName: "Approval",
        flex: 1,
        renderCell: (params) =>
          ...
          ) : params.row.approval.status === "committee" ? (
            <Button
              variant="contained"
